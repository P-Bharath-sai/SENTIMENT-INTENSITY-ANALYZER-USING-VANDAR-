...
if(neg1>0):
    ...
    if(pol>0):
        ...
        image = mpimg.imread("http://localhost:8888/view/alright.png")
    ...
    if(hos>0):
        ...
        image = mpimg.imread("/content/ambulance.jpeg")
        plt.title("Hospital service")
        plt.imshow(image)
        plt.show()

    if(fir>0):
        image = mpimg.imread("/content/fire.jpg")
...
get_ipython().system('pip install PyAudio-0.2.13-cp39-cp39-win_amd64.whl')
...
if(pos1<neg1):
    ...
    if(pol>0):
        print("police service")
        image = mpimg.imread("http://localhost:8888/view/police.png")
    ...
    if(hos>0):
        print("Hospital service")
        image = mpimg.imread("/http://localhost:8888/view/ambulance.png")
        plt.title("Hospital service")
        plt.imshow(image)
        plt.show()

    if(fir>0):
        image = mpimg.imread("http://localhost:8888/view/fire.png")
        plt.title("Fire service and Rescue team")
        plt.imshow(image)
        plt.show()
else:
